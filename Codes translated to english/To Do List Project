//Simple to do list code maked with javascript for node.js
// This code stores tasks saved in the "tasks" array into a file called "tasks.json" to persist the tasks even if the user exits VS Code.
